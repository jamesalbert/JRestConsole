...
class JRestConsole extends JFrame {
	private JLabel url_label, response_label, timeoutLabel, acceptLabel,
			payloadLabel;
	...
	private JButton get_button, post_button, put_button, delete_button,
			option_button, head_button, trace_button;
